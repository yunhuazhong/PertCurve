...
class PertData:
    ...
    def load(self, data_name = None, data_path = None):
        ...
        if data_name in ['norman', 'adamson', 'dixit', 
            ...
            adata_path = os.path.join(data_path, 'perturb_processed_with_scores.h5ad')
        ...
        if os.path.isfile(dataset_fname):
            ...
            # Same as the branch below: cache load skips create_dataset_file(),
            # but downstream code (and custom tools) still need ctrl cells + gene names.
